...
public class HttpClientImpl {
    ...
    public HttpClientImpl(String appName, int remotePort) {
        this.appName = appName;
        this.remotePort = remotePort;
        this.httpClient = getDefaultHttpClient(remotePort);
    }
...
//        pccm.setMaxTotal(100);          //客户端总并行链接最大数
     ...
     * @return
     */
    public boolean changeFileByHttpClient(String appName, String url, String charset, String fileName, File file) {
...
//                httpPost.releaseConnection();
    ...
    public boolean changeFileByHttpClient(String appName, String url, String charset, String fileName, byte[] data) {
        boolean isResult = false;
        try {
            ContentBody cbString = null;
            ContentBody cbFile = null;
...
//            cbString = new StringBody("参数", Charset.forName("utf-8"));
//            entity.addPart("传递的参数名", cbString);
            cbFile = new ByteArrayBody(data,charset);
//            cbFile = new FileBody(file);
            entity.addPart(fileName, cbFile);
            HttpPost httpPost = new HttpPost(url);
            httpPost.setEntity(entity);
