package com.hzih.itp.platform.dbchange.target.plugin.entirely;
...
import com.hzih.itp.platform.dbchange.target.plugin.TargetProcessEntirely;
...
public class TargetDBService extends DbInit{
    ...
    private TargetProcessEntirely targetProcess;
    ...
    public TargetDBService(TargetProcessEntirely targetProcess) {
