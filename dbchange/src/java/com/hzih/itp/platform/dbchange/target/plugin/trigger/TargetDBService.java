package com.hzih.itp.platform.dbchange.target.plugin.trigger;
...
import com.hzih.itp.platform.dbchange.target.plugin.TargetProcessTrigger;
...
public class TargetDBService extends DbInit{
    ...
    private TargetProcessTrigger targetProcess;
    ...
    public TargetDBService(TargetProcessTrigger targetProcess) {
