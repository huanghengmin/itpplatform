package com.hzih.itp.platform.dbchange.target.plugin.delete;
...
import com.hzih.itp.platform.dbchange.target.plugin.TargetProcessDelete;
...
public class TargetDBService extends DbInit {
    ...
    private TargetProcessDelete targetProcess;
    ...
    public TargetDBService(TargetProcessDelete targetProcess) {
