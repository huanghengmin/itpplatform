package com.hzih.itp.platform.dbchange.target.plugin.timesync;
...
import com.hzih.itp.platform.dbchange.target.plugin.TargetProcessTimeSync;
...
public class TargetDBService extends DbInit {
    ...
    private TargetProcessTimeSync targetProcess;
    ...
    public TargetDBService(TargetProcessTimeSync targetProcess) {
